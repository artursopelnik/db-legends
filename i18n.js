...
const I18N = {
  en: {
    subtitle: 'Save any number of friend codes and generate all QR codes at once – always fresh and ready to scan in-game. Everything runs locally; your list stays on your device.',
  ...
  de: {
    subtitle: 'Speichere beliebig viele Friend Codes und erzeuge alle QR-Codes gleichzeitig – frisch generiert und direkt im Spiel einscannbar. Alles läuft lokal, deine Liste bleibt gespeichert.',
    addHeading: 'Friend Code hinzufügen',
    codePlaceholder: 'Friend Code (z. B. umd74s5q8)',
    addBtn: 'Hinzufügen',
    errInvalid: 'Der Friend Code muss 8–10 Zeichen lang sein und darf nur Buchstaben und Zahlen enthalten.',
    errDuplicate: 'Dieser Friend Code ist bereits in deiner Liste.',
    ...
    emptyText: 'Noch keine Friend Codes gespeichert. Füge oben deinen ersten Code hinzu.',
    ...
    toastCopied: 'Friend Code kopiert!',
    ...
    deleteConfirm: 'Friend Code „{code}“ wirklich löschen?',
